...
struct QuestionView: View {
    ...
    let LiteratureQuestion: [Question] = [
        ...
        Question(text: "In Book 8, Adam asks Raphael about:", options: ["The nature of evil", "Astronomy and the cosmos", "Satan's rebellion", "The future"], answer: "Astronomy and the cosmos"),
        ...
        Question(text: "'I thence / Invoke thy aid to my adventrous Song, / That with no middle flight intends to soar / Above th' Aonian Mount' - Which book is this invocation from?", options: ["Book 1", "Book 3", "Book 7", "Book 9"], answer: "Book 1"),
        Question(text: "'Things unattempted yet in Prose or Rhime' - Who speaks this line?", options: ["Satan", "God", "Milton", "Adam"], answer: "Milton"),
        Question(text: "'What in me is dark / Illumin, what is low raise and support' - This prayer for divine assistance appears in which book?", options: ["Book 1", "Book 2", "Book 3", "Book 5"], answer: "Book 1"),
        Question(text: "'That to the highth of this great Argument / I may assert Eternal Providence, / And justifie the wayes of God to men' - Who is the speaker?", options: ["God the Father", "The Son", "Milton", "Raphael"], answer: "Milton"),
        Question(text: "'What though the field be lost? / All is not lost; the unconquerable Will, / And study of revenge, immortal hate' - Who delivers this defiant speech?", options: ["Beelzebub", "Moloch", "Satan", "Belial"], answer: "Satan"),
        Question(text: "'And courage never to submit or yield: / And what is else not to be overcome?' - This declaration of defiance is from which book?", options: ["Book 1", "Book 2", "Book 4", "Book 10"], answer: "Book 1"),
        Question(text: "'That Glory never shall his wrath or might / Extort from me' - To whom does Satan refuse to yield glory?", options: ["Michael", "The Son", "God", "Gabriel"], answer: "God"),
        Question(text: "The passage 'All is not lost; the unconquerable Will, / And study of revenge, immortal hate' reveals Satan's primary characteristics as:", options: ["Repentance and sorrow", "Defiance and determination for revenge", " Fear and submission", "Wisdom and acceptance"], answer: "Defiance and determination for revenge"),
        Question(text: "'I may assert Eternal Providence, / And justifie the wayes of God to men' - This states the epic's main purpose in which book?", options: ["Book 1", "Book 3", "Book 12", "Book 9"], answer: "Book 1"),
        Question(text: "'So much the rather thou Celestial light / Shine inward, and the mind through all her powers / Irradiate' - Who invokes celestial light?", options: ["God", "Milton", "Adam", "Raphael"], answer: "Milton"),
        Question(text: "'There plant eyes, all mist from thence / Purge and disperse, that I may see and tell / Of things invisible to mortal sight' - This invocation appears in which book?", options: ["Book 1", "Book 2", "Book 3", "Book 7"], answer: "Book 3"),
        Question(text: "The invocation to 'Celestial light' in Book 3 is significant because it references Milton's:", options: ["Youth", "Education", "Blindness", "Political career"], answer: "Blindness"),
        Question(text: "'Whose fault? / Whose but his own? ingrate, he had of mee / All he could have' - Who speaks these words?", options: ["Satan", "Michael", "God the Father", "The Son"], answer: "God the Father"),
        Question(text: "'I made him just and right, / Sufficient to have stood, though free to fall' - This famous statement about humanity's free will is in which book?", options: ["Book 1", "Book 3", "Book 8", "Book 9"], answer: "Book 3"),
        Question(text: "'Sufficient to have stood, though free to fall' - God is speaking about:", options: ["Satan", "The fallen angels", "Adam (and humanity)", "Eve specifically"], answer: "Adam (and humanity)"),
        Question(text: "'As when a prowling Wolfe, / Whom hunger drives to seek new haunt for prey' - This simile compares to whom?", options: ["Death", "Satan", "Sin", "A demon"], answer: "Satan"),
        Question(text: "'Watching where Shepherds pen thir Flocks at eeve / In hurdl'd Cotes amid the field secure, / Leaps o're the fence with ease into the Fould' - This is from which book?", options: [" Book 2", " Book 3", " Book 4", " Book 9"], answer: " Book 4"),
        Question(text: "'Or as a Thief bent to unhoord the cash / Of some rich Burgher' - This second simile also describes:", options: ["Sin leaving Hell", "Satan entering Paradise", "Adam approaching the Tree", "The serpent approaching Eve"], answer: "Satan entering Paradise"),
        Question(text: "'So clomb this first grand Thief into Gods Fould' - Who is called 'this first grand Thief'?", options: ["Beelzebub", "Mammon", "Satan", " Death"], answer: "Satan"),
        Question(text: "The wolf and thief similes comparing Satan's entry into Paradise appear in which book?", options: ["Book 2", "Book 4", "Book 5", "Book 9"], answer: "Book 4"),
        Question(text: "'Thence up he flew, and on the Tree of Life, / The middle Tree and highest there that grew, / Sat like a Cormorant' - Who sat like a cormorant?", options: ["Gabriel", "Satan", "Ithuriel", "Uriel"], answer: "Satan"),
        Question(text: "'Sat like a Cormorant' on the Tree of Life - This image appears in which book?", options: ["Book 1", "Book 2", "Book 4", "Book 9"], answer: "Book 4"),
        Question(text: "Why does Satan sit in the Tree of Life like a cormorant?", options: ["To eat fruit", "To rest after his journey", "To survey Paradise and plot evil", "To hide from the angels"], answer: "To survey Paradise and plot evil"),
        Question(text: "'So since into his Church lewd Hirelings climbe' - This line suggests Milton's criticism of:", options: ["Satan's followers", "Corrupt clergy", "Adam and Eve", "Angelic hierarchy"], answer: "Corrupt clergy"),
        Question(text: "The cormorant simile emphasizes Satan's role as:", options: ["A predator observing his prey", "A beautiful creature", "A repentant sinner", "A wise observer"], answer: "A predator observing his prey"),
        Question(text: "'Two of far nobler shape erect and tall, / Godlike erect, with native Honour clad / In naked Majestie seemd Lords of all' - Who is being described?", options: ["Two angels", "Adam and Eve", "Satan and Beelzebub", " Michael and Gabriel"], answer: "Adam and Eve"),
        Question(text: "'For in thir looks Divine / The image of thir glorious Maker shon' - This description is from which book?", options: ["Book 1", "Book 4", "Book 8", "Book 9"], answer: "Book 4"),
        Question(text: "'Truth, wisdome, Sanctitude severe and pure, / Severe but in true filial freedom plac't' - These qualities describe:", options: ["The angels", "Adam and Eve before the Fall", "God and the Son", "Satan before his fall"], answer: "Adam and Eve before the Fall"),
        Question(text: "The phrase 'In naked Majestie seemd Lords of all' emphasizes Adam and Eve's:", options: ["Shame", "Innocence and natural dignity", "Weakness", "Pride"], answer: "Innocence and natural dignity"),
        Question(text: "'Not to taste that onely Tree / Of knowledge, planted by the Tree of Life, / So neer grows Death to Life' - Who speaks this?", options: ["God", "Raphael", "Adam", "Eve"], answer: "Adam"),
        Question(text: "'God hath pronounc't it death to taste that Tree, / The only sign of our obedience left' - Adam explains this prohibition in which book?", options: ["Book 3", "Book 4", "Book 5", "Book 8"], answer: "Book 4"),
        Question(text: "'Among so many signes of power and rule / Conferrd upon us, and Dominion giv'n / Over all other Creatures' - Adam is speaking to:", options: ["God", "Raphael", "Michael", "Eve"], answer: "Eve"),
        Question(text: "'So neer grows Death to Life, what ere Death is, / Som dreadful thing no doubt' - This shows Adam's understanding of death is:", options: ["Complete and accurate", " Incomplete; he doesn't fully comprehend it", "Wrong and misguided", "Fearful and paralyzing"], answer: " Incomplete; he doesn't fully comprehend it"),
        Question(text: "'That day I oft remember, when from sleep / I first awak't, and found my self repos'd / Under a shade of flours' - Who recalls this memory?", options: ["Satan", "Raphael", "Adam", "Eve"], answer: "Eve"),
        Question(text: "'Much wondring where / And what I was, whence thither brought, and how' - Eve's first awakening is recounted in which book?", options: ["Book 4", "Book 5", "Book 8", "Book 9"], answer: "Book 4"),
        Question(text: "'Joy thou / In what he gives to thee, this Paradise / And thy faire Eve; Heav'n is for thee too high / To know what passes there' - Who gives this advice?", options: ["God", "Raphael", "Michael", "Gabriel"], answer: "Raphael"),
        Question(text: "'Be lowlie wise: / Think onely what concernes thee and thy being; / Dream not of other Worlds' - This counsel to Adam appears in which book?", options: ["Book 5", "Book 6", "Book 7", "Book 8"], answer: "Book 8"),
        Question(text: "'Contented that thus farr hath been reveal'd / Not of Earth onely but of highest Heav'n' - Raphael is advising Adam about:", options: ["His relationship with Eve", "The limits of human knowledge and curiosity", " How to resist Satan", "The nature of sin"], answer: "The limits of human knowledge and curiosity"),
        Question(text: "'Heav'n is for thee too high / To know what passes there; be lowlie wise' - Raphael's advice emphasizes:", options: ["Human inferiority", "The virtue of humility and focusing on appropriate knowledge", "The impossibility of wisdom", "Fear of God"], answer: "The virtue of humility and focusing on appropriate knowledge"),
        Question(text: "'For well I understand in the prime end / Of Nature her th' inferiour, in the mind / And inward Faculties, which most excell' - Who speaks about Eve this way?", options: ["God", "Raphael", "Adam", "Satan"], answer: "Adam"),
        Question(text: "'In outward also her resembling less / His Image who made both, and less expressing / The character of that Dominion giv'n' - Adam's view of Eve in Book 8 suggests:", options: ["Complete equality", "Hierarchical difference with Eve as inferior", "Eve's superiority", "No difference between them"], answer: "Hierarchical difference with Eve as inferior"),
        Question(text: "Adam's discussion of Eve's inferiority 'in the mind / And inward Faculties' occurs in which book?", options: ["Book 4", "Book 5", "Book 8", "Book 9"], answer: "Book 8"),
        Question(text: "'But that thou shouldst my firmness therfore doubt / To God or thee, because we have a foe / May tempt it, I expected not to hear' - Who speaks this?", options: ["Satan", "Raphael", "Adam", "Eve"], answer: "Eve"),
        Question(text: "'I expected not to hear' Eve say this in response to Adam's:", options: ["Command to stay with him", "Concern about her working alone", "Discussion of the forbidden tree", "Description of Satan"], answer: "Concern about her working alone"),
        Question(text: "'Why shouldst not thou like sense within thee feel / When I am present, and thy trial choose / With me, best witness of thy Vertue tri'd' - Eve says this in which book?", options: ["Book 4", "Book 8", "Book 9", "Book 10"], answer: "Book 9"),
        Question(text: "'And thy trial choose / With me, best witness of thy Vertue tri'd' - Eve is arguing for:", options: ["Leaving Paradise", "Working separately from Adam", "Eating the forbidden fruit", "Speaking to the angels"], answer: "Working separately from Adam"),
        Question(text: "'With tract oblique / At first, as one who sought access, but feard / To interrupt, side-long he works his way' - This describes:", options: ["Adam approaching Eve", "Gabriel patrolling Paradise", "Satan (in the serpent) approaching Eve", "Raphael arriving in Paradise"], answer: "Satan (in the serpent) approaching Eve"),
        Question(text: "'As when a Ship by skilful Stearsman wrought / Nigh Rivers mouth or Foreland, where the Wind / Veres oft, as oft so steers, and shifts her Saile' - This nautical simile appears in which book?", options: ["Book 4", "Book 9", "Book 10", "Book 12"], answer: "Book 9"),
        Question(text: "The ship simile 'With tract oblique... side-long he works his way' emphasizes Satan's:", options: ["Direct approach", "Cunning and indirect strategy", "Honesty", "Confusion"], answer: "Cunning and indirect strategy"),
        Question(text: "'Why then was this forbid? Why but to awe, / Why but to keep ye low and ignorant, / His worshippers' - Who speaks this deceptive argument?", options: ["Beelzebub", "Satan (as the serpent)", "Belial", "Eve to herself"], answer: "Satan (as the serpent)"),
        Question(text: "'Why but to keep ye low and ignorant, / His worshippers' - Satan's temptation accuses God of:", options: ["Cruelty", "Withholding knowledge to maintain power", "Abandoning humanity", "Being unjust in punishment"], answer: "Withholding knowledge to maintain power"),
        Question(text: "Satan's question 'Why then was this forbid?' appears in which book?", options: ["Book 4", "Book 5", "Book 9", "Book 10"], answer: "Book 9"),
        Question(text: "'But to Adam in what sort / Shall I appeer? shall I to him make known / As yet my change' - Who contemplates this question?", options: ["God", "Raphael", "Satan", "Eve"], answer: "Eve"),
        Question(text: "'Or rather not, / But keep the odds of Knowledge in my power / Without Copartner?' - Eve considers this in which book?", options: ["Book 4", "Book 8", "Book 9", "Book 10"], answer: "Book 9"),
        Question(text: "'But keep the odds of Knowledge in my power / Without Copartner?' - This reveals Eve's:", options: ["Love for Adam", "Selfish desire to maintain superiority over Adam", "Obedience to God", "Fear of death"], answer: "Selfish desire to maintain superiority over Adam"),
        Question(text: "'There they thir fill of Love and Loves disport / Took largely, of thir mutual guilt the Seale, / The solace of thir sin' - This describes:", options: ["Adam and Eve before the Fall", "Adam and Eve's lust after the Fall", "Satan and Sin", "The fallen angels"], answer: "Adam and Eve's lust after the Fall"),
        Question(text: "'Between us two let there be peace, both joyning, / As joyn'd in injuries, one enmitie / Against a Foe by doom express assign'd us, / That cruel Serpent' - Who proposes this reconciliation?", options: ["The Son", "Michael", "Adam", "Eve"], answer: "Eve"),
        Question(text: "'Both have sin'd, but thou / Against God onely, I against God and thee' - Eve's acknowledgment of guilt appears in which book?", options: ["Book 9", "Book 10", "Book 11", "Book 12"], answer: "Book 10"),
        Question(text: "'This further consolation yet secure / I carry hence; though all by mee is lost, / Such favour I unworthie am voutsaft, / By mee the Promis'd Seed shall all restore' - Who speaks these final words of hope?", options: ["The Son", "Michael", "Adam", "Eve"], answer: "Adam"),
        Question(text: "'By mee the Promis'd Seed shall all restore' - Adam's understanding of redemption through Christ appears in which book?", options: ["Book 9", "Book 10", "Book 11", "Book 12"], answer: "Book 12")
    ]
